...
TextField resuableTextField(String text, IconData icon, bool isPassword, TextEditingController controller)
{
  return TextField(
    ...
    child: ElevatedButton(
      ...
      style: ButtonStyle(
        backgroundColor: MaterialStateProperty.resolveWith<Color>(
            ...
            if (states.contains(MaterialState.pressed)) return Colors.white.withAlpha(200);

...
class _QuizCreationState extends State<QuizCreation> {
  ...
  final TextEditingController _QuestionnaireController =
  ...
  void initState() {
    ...
    if (widget.editUId != null) {
      ...
      questionCreationState.finishQuestionnaire(context, _QuestionController, widget.editUId!);
    }
  }
              ...
              child: FutureBuilder<String>(
                ...
                builder:
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Consumer<QuestionCreationState>(builder: (context, state, _){
                      return Column(
                        // main body
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      state.finishQuestionnaire(context);
                                    },
...
class QuestionCreationState extends ChangeNotifier {
  ...
  Future<void> fetchQuestainnaireEdit(String uId) async {
    this.questionnaire =
        await QuestionnaireService().getQuestionnaire(uId);
  ...
  void editQuestionCall(int newIndex, context, TextEditingController questionController) {
              ...
              actions: <Widget>[
                TextButton(
                    onPressed: () {
                      ...
                      questionCreation(context, questionController);
  ...
  finishQuestionnaire(context, TextEditingController controller, String uId) {
          ...
          builder: (context) {
            ...
            return AlertDialog(
              ...
              content: QuizTextFields(
                  controller, "name here...", "Add your name"),
              actions: [
                TextButton(
                    onPressed: () async {
  ...
  void questionCreation(BuildContext context, TextEditingController questionController) {
